...
def  test_load_session1():
    with app.test_client() as web:
            ...
            print(f'{gothonweb_path}/gothonweb/gothonweb/sessions/new_user_gothonweb.txt')
            file_exists = exists(f'{gothonweb_path}/gothonweb-2.0/gothonweb/sessions/new_user_gothonweb.txt')
            assert file_exists
...
def  test_load_session2():
    with app.test_client() as web:
            ...
            rv = web.post('/login', follow_redirects=True, data=data)
            load_session('new_user')
            file_name = f'{gothonweb_path}/gothonweb-2.0/gothonweb/sessions/new_user_gothonweb.txt'
